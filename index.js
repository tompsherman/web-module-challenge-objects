...
console.log(createMenuItem("beer", 3, "dinner"));
...
for (i=0; i<reviews.length; i++){
  if (reviews[i].name === "Julius"){
    newFeedback.push(reviews[i].feedback)
  }
}
...
console.log(addReview(reviews, "tom", 1.5, "the food is ok, but the problems are hard"))
